...
@allure.story("1.Successful purchase")
@scenario("../fixtures/purchase.feature","Successful purchase of a single product")
def test_successful_purchase():
    pass

@allure.feature("Purchase flow")
@allure.story("2.Purchase different products")
@scenario("../fixtures/purchase.feature","Purchase different products")
def test_purchase_different_products():
    pass

@allure.feature("Purchase flow")
@allure.story("3.Failed purchase")
@scenario("../fixtures/purchase.feature","Failed purchase with invalid information")
